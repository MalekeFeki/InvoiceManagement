            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('factures.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">num facture </label>
                                <input type="text" class="form-control" id="inputName" name="num_facture"
                                    title="veuillez entrer le numéro de la facture" required>
                            </div>

                            <div class="col">
                                <label>Date début </label>
                                <input class="form-control fc-datepicker" name="date_debut" placeholder="YYYY-MM-DD"
                        ...
                        <h5 class="card-title">photo facture</h5>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" href="{{url("/factures.factures")}}" class="btn btn-primary">Enregistrer </button>
                        </div>
